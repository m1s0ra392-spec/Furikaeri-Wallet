...
urlpatterns = [
    ...
    path("search/", views.search, name="search"),#キーワード検索（入力フォーム）
    path("search/result/", views.topic_search, name="topic_search"),#キーワード検索結果
    ...
    path("<int:topic_pk>/comments/confirm/", views.comment_confirm, name="comment_confirm"),#コメント確認
